        ...
        return (
            <View>
                ...
                <View style={styles.content}>
                    ...
                    <Text>From:</Text>
                    <RNPickerSelect key={"sel1"} placeholder={"Select an item"}
                        onValueChange={(value) => {this.sel1 = value;}}
                        items={sel}
                    />
                    <Text>To:</Text>
                    <RNPickerSelect
                        key={"sel2"} placeholder={"Select an item"}
                        onValueChange={(value) => {this.sel2 = value;}}
                        items={sel}
                    />
                    <Text>Value:</Text>
